...
* `snafu` installation (https://github.com/cloud-bulldozer/snafu).
* `vegeta` installation (https://github.com/tsenart/vegeta).
## **Installation**
...
### **Example**
```
START=1 END=10000 IMAGES="quay.io/clair-load-test/mysql:8.0.25" LOAD_REPO="quay.io/vchalla/clair-load-test" RATE=20 bash image_load.sh
```
...
OPTIONS:
   ...
   --uuid value            --uuid f519d9b2-aa62-44ab-9ce8-4156b712f6d2 (default: "14484a83-abba-483c-9b66-3b5ce93b4088") [$CLAIR_TEST_UUID]
